...
pub(crate) fn validate_output_directory(path: &Path) -> Result<(), std::io::Error> {
...
pub(crate) fn read_archive_file_safely(
...
pub(crate) fn cleanup_temp_file(temp_path: &std::path::Path, error_handler: &ErrorHandler) {
