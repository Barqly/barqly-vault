...
_Agent-optimized context system reference_
...
update_responsibility:
  ["master context", "coordinate domain updates", "archive sprints"]
```
...
```yaml
primary_files:
  ["/docs/architecture/context.md", "technology-decisions.md", "ADDs"]
update_responsibility:
  ["architecture context", "decision documentation", "tech stack"]
```
...
```yaml
primary_files:
  ["/docs/engineering/context.md", "api-reference.md", "quality-standards.md"]
