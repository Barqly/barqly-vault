...
const ERROR_MESSAGES = {
  WRONG_KEY:
    "This file was encrypted with a different key. Please select the correct key.",
  INVALID_PASSPHRASE: "Incorrect passphrase. Please try again.",
  CORRUPTED_FILE:
    "This file appears to be corrupted. The integrity check failed.",
  PERMISSION_DENIED:
    "Cannot access this location. Please check folder permissions.",
};
```
