      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Generate your first encryption key to get started with secure file encryption for Bitcoin custody backup.
          </p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-sm text-blue-800">
            ...
            <div>
              ...
              <p>Use your key to encrypt important files like wallet backups and recovery information.</p>
            </div>
            <div>
              <h3 className="font-medium mb-2">3. Secure Storage</h3>
              <p>Store encrypted files safely and share the public key with trusted family members.</p>
            </div>
          </div>
        </div>
      </div>
