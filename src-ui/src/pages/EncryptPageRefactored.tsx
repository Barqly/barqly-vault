...
/**
 * Main encryption page component - Refactored with progressive disclosure
 * Uses step-based navigation similar to successful DecryptPage pattern
 */
const EncryptPageRefactored: React.FC = () => {
  return (
    <EncryptFlowProvider>
      <EncryptPageContent />
    </EncryptFlowProvider>
...
export default EncryptPageRefactored;
