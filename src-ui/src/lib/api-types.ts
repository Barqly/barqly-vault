 ...
 *
 * This file is automatically generated from Rust backend types.
 * ANY MANUAL CHANGES WILL BE LOST on the next type generation.
 *
 * IMPORTANT FOR AI AGENTS AND DEVELOPERS:
 * - DO NOT manually edit this file
 * - DO NOT refactor this file for line count or readability
 * - DO NOT add helper functions or utilities here
 * - This file maintains the contract between frontend and backend
 *
 * To regenerate this file:
 * 1. cd src-tauri && cargo build --features generate-types
 * 2. Find the generated file in target/debug/build/barqly-vault-[hash]/out/generated/types.ts
 * 3. Copy it to src-ui/src/lib/api-types.ts
 * 4. Add this warning header back to the top of the file
 *
 * For TypeScript helpers and utilities, use separate files like:
 * - api-helpers.ts for utility functions
 * - command-error.ts for error handling extensions
 *
 * Generated on: 2025-08-09T01:56:59.544944+00:00
 * Source: Rust backend type definitions
 */
