...
interface VaultOperationSummaryProps {
  /** Title for the summary box (e.g., "Encryption Summary:" or "Decryption Summary:") */
  title: string;
  /** Name of the vault */
  vaultName: string;
  ...
  /** Total size in bytes */
  totalSize: number;
  /** Output path for the vault/files */
  outputPath: string;
}

/**
 * Shared summary component for encrypt/decrypt success pages
 * Displays vault name, file count, size, and location with copy functionality
 */
const VaultOperationSummary: React.FC<VaultOperationSummaryProps> = ({
  title,
  vaultName,
  fileCount,
  totalSize,
...
export default VaultOperationSummary;
