      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
          ...
          <div className="p-6">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="text-sm text-amber-800 font-medium">
                            No initialized YubiKeys found
                          </p>
                          <p className="text-sm text-amber-700 mt-1">
                            Insert your YubiKey to set it up for this vault. The green light should
                            be blinking.
                          </p>
                        </div>
                      </div>
            ...
            {step === 'setup' &&
              selectedKey &&
              (selectedKey.state === 'orphaned' || selectedKey.state === 'reused') && (
                <>
                  <div className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-700 mt-1">
                            This YubiKey is already initialized. Just provide a label to attach it
                            to this vault.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                      <div className="flex gap-2">
                        ...
                        <p className="text-sm text-amber-800">
                          You'll be prompted for your YubiKey PIN when encrypting or decrypting
                          files.
                        </p>
                      </div>
                    </div>
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            const registerResult =
                              await commands.registerYubikeyForVault(registerParams);
                            if (registerResult.status === 'error') {
                              throw new Error(
                                registerResult.error.message || 'Failed to register YubiKey',
                              );
                            }
            ...
            {/* Debug: Show when no form matches */}
            {step === 'setup' &&
              selectedKey &&
              selectedKey.state !== 'new' &&
              selectedKey.state !== 'orphaned' &&
              selectedKey.state !== 'reused' && (
                <div className="space-y-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <p className="text-red-800">
                    Debug: No UI form matches for state: <strong>{selectedKey.state}</strong>
                  </p>
                  <p className="text-sm text-red-600">Serial: {selectedKey.serial}</p>
                </div>
              )}
