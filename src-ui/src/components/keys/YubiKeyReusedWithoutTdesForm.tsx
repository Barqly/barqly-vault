...
/**
 * Form for REUSED YubiKeys without TDES (Scenario 2)
 * Has custom PIN/PUK but no TDES management key
 * Needs to setup management and generate age encryption key
 * Touch required
 */
export const YubiKeyReusedWithoutTdesForm: React.FC<YubiKeyReusedWithoutTdesFormProps> = ({
  selectedKey,
  label,
  setLabel,
  pin,
